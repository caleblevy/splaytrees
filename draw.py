...
if __name__ == '__main__':
    ...
    for i, k in enumerate("aihjgfclkendbpmoi"[:-1]):
        # plot_subtree(t_samp.root, "wilber/wilber_sample_" + str(i) + ".pdf")
        t_samp.move_to_root(k)
    print(t_samp.preorder())
    t_samp.move_to_root("e")
    plot_subtree(t_samp.root, "s_u.pdf")
    t_samp.move_to_root("k")
    plot_subtree(t_samp.root, "s_uv.pdf")
    t_samp.move_to_root("a")
    t_samp.move_to_root("o")
    plot_subtree(t_samp.root, "s_uvv.pdf")
    t_samp.move_to_root("k")
    plot_subtree(t_samp.root, "s_uvvv.pdf")
