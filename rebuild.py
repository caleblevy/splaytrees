"""Determine whether a the resultant tree of splaying a permutation can be
partitioned into connected groups of constant size that remain connected
regardless of starting tree."""
